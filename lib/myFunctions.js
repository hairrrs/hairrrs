...
export const handleSwitchAccount = async (uid) => {
    ...
    try {
        ...
        if (userSnapshot.exists) {
            ...
            // auth.
            signInWithEmailAndPassword(auth, userSnapshot.data().email, decodedPassword)
            localStorage.removeItem("user");
            UserProfile.setUser(userSnapshot.data()); // also set the auth current user to this new user
            return 'success'
        } else {
